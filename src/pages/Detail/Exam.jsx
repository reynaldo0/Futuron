        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-primary-200/60 border-2 border-primary-400 shadow-md rounded-lg p-6 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-bold text-black mb-2">Panel Surya</h3>
            ...
            {/* Card 2 */}
            <div className="bg-primary-200/60 border-2 border-primary-400 shadow-md rounded-lg p-6 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-bold text-black mb-2">Pengolahan Air Limbah</h3>
              <p className="text-gray-700">
            ...
            {/* Card 3 */}
            <div className="bg-primary-200/60 border-2 border-primary-400 shadow-md rounded-lg p-6 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-bold text-black mb-2">Kendaraan Listrik</h3>
              <p className="text-gray-700">
            ...
            {/* Card 4 */}
            <div className="bg-primary-200/60 border-2 border-primary-400 shadow-md rounded-lg p-6 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-bold text-black mb-2">Pertanian Berkelanjutan</h3>
              <p className="text-gray-700">
            ...
            <div className="hidden md:block bg-primary-200/60 border-2 border-primary-400 shadow-md rounded-lg p-6 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-bold text-black mb-2">Energi Angin</h3>
              <p className="text-gray-700">
            ...
            <div className="hidden md:block bg-primary-200/60 border-2 border-primary-400 shadow-md rounded-lg p-6 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-bold text-black mb-2">Biogas</h3>
              <p className="text-gray-700">
