...
const Approach = () => {
  return (
    <section className="py-16 px-6 md:px-20 relative">
      <h2 className="text-4xl font-bold text-center text-primary-400">Pendekatan Kami</h2>
      ...
      <div className="mt-12 flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="flex-shrink-0 hidden md:block md:relative">
          <div className="flex justify-center items-center scale-150 text-primary-300 text-9xl animate-bounce">
