...
import { Leaf, Sun, Recycle } from 'lucide-react'; // Ikon dari Lucide React
      ...
      <div className="container mx-auto px-4 text-center">
            ...
            >
              <div className="p-6 flex flex-col items-center">
                <div className="bg-green-200 p-3 rounded-full mb-4">
                  <Leaf className="text-green-600 text-4xl" /> {/* Ikon untuk teknologi */}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-white text-gray-800 rounded-lg shadow-lg p-6 transition-transform transform hover:scale-105 duration-300 flex items-center"
            >
