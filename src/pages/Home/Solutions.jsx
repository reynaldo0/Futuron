  ...
  return (
    <section className="py-16 text-primary-400" id="solutions">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl pt-20 md:text-5xl font-bold text-center mb-12" data-aos="fade-up"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8  md:px-10">
          {SolutionsData.map((solution) => (
            <div
              key={solution.id}
              className="bg-white text-gray-900 shadow-lg rounded-lg p-6 hover:scale-105 transition-transform hover:shadow-2xl hover:bg-primary-200 hover:text-white group border-2 border-y-primary-300" data-aos="fade-up"
